import type { Bug, Developer, PullRequest, ReportDate } from "./types";
...
// 1.3 Return true when bug is high/critical, active, and in staging/production.
...
// 1.4 Classify pull request size.
